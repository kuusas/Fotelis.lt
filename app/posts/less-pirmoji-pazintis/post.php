<p>Šiuo postu pradėsiu postų seriją apie tai kaip šiuo metu mano aplinkoje vyksta darbas su web projektų dizaino dalimi - HTML + CSS.<br />
Pradėsiu nuo LESS.</p>

<h2>Kas yra LESS ir kam jis skirtas</h2>

<p>LESS http://lesscss.org/ - dinaminė stilių rašymo kalba. Pagrindiniai privalumai tai, kad ji turi: kintamuosius, mixinus, nestingą, funkcijas ir operatorius. Su jų pagalba rašomas aiškesnis, struktūrizuotas neatsikartojantis kodas, o kur reikalingi aritmetiniai veiksmai - išvis pasaka!</p>
...
<p>Visų šių LESS įrankių pagalba formuojamas gražus ir aiškus kodas išvengiant selectorių ir savybių dubliavimo. Visumoj tai panašu į dar vieną programavimo kalbą CSS pagrindu ir deje to nesupranta naršyklės.</p>
